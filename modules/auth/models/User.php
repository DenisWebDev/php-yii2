...
class User extends UserBase implements IdentityInterface
{
    ...
    public function rules()
    {
        return array_merge([
            ...
            ['email', 'exist', 'on' => static::SCENARIO_AUTH],
    ...
    {
        $this->setScenario(static::SCENARIO_REGISTER);
    }

    public function setAuthScenario()
    {
        $this->setScenario(static::SCENARIO_AUTH);
    }
    ...
    {
        return static::find()->cache(5)->where(['id' => $id])->one();
    }
